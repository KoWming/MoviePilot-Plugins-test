                                        ...
                                        'content': [
                                            {
                                                ...
                                                'content': [{
                                                    'component': 'tr',
                                                    'content': [
                                                        {'component': 'th', 'props': {'width': '100'}, 'text': '启用'},
                                                        {'component': 'th', 'text': '站点名称'},
                                                        {'component': 'th', 'text': 'URL'},
                                                        {'component': 'th', 'text': 'Cookie'},
                                                        {'component': 'th', 'text': 'Referer'},
                                                        {'component': 'th', 'text': '消息内容'},
                                                    ]
                                                }]
                                            },
                                            {
